[![Build Status](https://travis.ibm.com/IBMi-Cloud/ibm.ibmi_core.svg?token=dtszmgAzVqEQEadyZ3XC&branch=master)](https://travis.ibm.com/IBMi-Cloud/ibm.ibmi_core)

# power_ibmi
The IBM i core collection includes modules. action plugins, sample playbooks and ansible-doc to automate tasks on IBM i
...
3. Run "ansible-galaxy collection build ."
4. Run "ansible-galaxy collection install *.gz"
5. Create your inventory file under examples/ibmi, an example can be found here "examples/ibmi/hosts_ibmi.ini"
6. Run "ansible-playbook -i examples/ibmi/your_inventory_file examples/ibmi/playbooks/enable-ansible-for-i/setup.yml"</br>
